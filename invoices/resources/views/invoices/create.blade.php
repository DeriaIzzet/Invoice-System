    ...
    <form action="{{ route('invoices.store') }}" method="POST" class="mb-3">
        ...
        <div id="line-items" class="mb-3">
            <div class="line-item mb-2">
                ...
                <input type="number" class="" name="line_items[0][quantity]" placeholder="Quantity"
                    onchange="updateTotal()" required>
                <input type="number" class="" step="0.01" name="line_items[0][unit_price]" placeholder="Unit Price"
                    onchange="updateTotal()" required>
